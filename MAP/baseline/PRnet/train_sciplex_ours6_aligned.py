...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train PRnet on Sciplex dataset (aligned with ours_6)"
    )
    ...
    parser.add_argument("--save_dir", type=str, default="./outputs_prnet_sciplex",
...
def main():
    ...
    run_name = f"prnet_sciplex_{'UC' if args.UC else 'random'}_{timestamp}"
    ...
    print(f"\n{'='*60}")
    print(f"Training PRnet on Sciplex dataset")
